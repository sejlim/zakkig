  ...
  return (
    <>
      ...
      <p>
        ...
        weiterentwickelte und sicherere Version von SSL, gewährleistet, dass all
        Datenübertragungen den höchsten Sicherheitsstandards entsprechen. Wenn
        eine Website durch ein SSL-/TLS-Zertifikat gesichert ist, wird dies
      ...
      <ul>
        ...
        <li>
          <strong>Zwecke der Verarbeitung:</strong> Zusendung von Neuigkeiten
          zum Projekt; Informationen zum offiziellen Release und Angeboten.
        </li>
        <li>
          <strong>Aufbewahrung und Löschung:</strong> Löschung entsprechend den
          Angaben im Abschnitt "Allgemeine Informationen zur Datenspeicherung
          und Löschung", unmittelbar nach Erhalt einer Löschanfrage per E-Mail
          oder über den Abmeldelink, der am Ende jeder unserer E-Mails zur
          Löschung aus der Datenbank bereitgestellt wird.
        </li>
        <li>
          <strong>Rechtsgrundlagen:</strong> Einwilligung (Art. 6 Abs. 1 S. 1
          lit. a) DSGVO) sowie vorvertragliche Maßnahmen (Art. 6 Abs. 1 S. 1
          lit. b) DSGVO).
        </li>
      </ul>
    </>
