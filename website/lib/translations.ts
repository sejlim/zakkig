...
export const translations = {
  de: {
    ...
    metaDescription: 'Bestellung und Bezahlung per QR-Code direkt am Tisch oder zum Mitnehmen. Dein Personal gewinnt Zeit für das Wesentliche.',
  ...
  en: {
    ...
    metaDescription: 'Ordering and payment via QR code at the table or for takeout. Your staff wins time for what matters.',
