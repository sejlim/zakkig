...
const translations = {
  de: {
    ...
    resetPasswordDescription: 'Gib deine E-Mail-Adresse ein und wir schicken dir einen Link zum Zurücksetzen deines Passworts.',
    resetPasswordSent: 'Wir haben dir eine E-Mail zum Zurücksetzen deines Passworts gesendet, folge den Anweisungen.',
    ...
    agreeToTermsDesc: 'Durch die Registrierung erklärst du dich mit unseren AGB und unserer Datenschutzerklärung einverstanden.',
    missingFields: 'Bitte fülle alle Pflichtfelder aus.',
    sessionFailed: 'Konto erstellt, aber Sitzung fehlgeschlagen.',
    signUpFailed: 'Registrierung fehlgeschlagen.',
    resetFailed: 'Zurücksetzen fehlgeschlagen.',
    databaseError: 'Ein Datenbankfehler ist aufgetreten. Bitte versuche es später erneut.',
    ...
    kitchenSessionsDesc: 'Erstelle eine Sitzung und öffne den Link auf einem Tablet, zugänglich zur Bedienung und ggf. Küche. Eingehende Bestellungen erscheinen dort mit allen Details in Echtzeit und können verwaltet werden.',
    ...
    qrCodeSublineBase: 'Bestelle entweder wie gewohnt beim Personal oder füge gewünschte Artikel deinem Warenkorb hinzu und bezahle direkt über das Handy.',
    qrCodeSublineToStay: 'Nach Abschluss der Bezahlung wird dir deine Bestellung direkt an deinen Tisch gebracht.',
    qrCodeSublineToGo: 'Nach Abschluss der Bezahlung wirst du auf eine Warteseite weitergeleitet, auf der du sehen kannst ob deine Bestellung abholbereit ist.',
    qrCodeAdminDescToGo: 'Drucke diesen QR-Code aus und platziere ihn gut sichtbar für deine Kunden. Sobald das Feature aktiviert ist, können Kunden direkt darüber bestellen.',
    qrCodeAdminDescToStay: 'Trage die gewünschte Tischnummer ein, drucke den QR-Code aus und platziere ihn auf dem entsprechenden Tisch. Sobald das Feature aktiviert ist, können Kunden direkt von dort bestellen.',
    ...
    paymentDisclaimer: 'Die technische Bestell- und Zahlungsabwicklung erfolgt über zakkig als Vermittler.',
    ...
    waitAtTable: 'Bitte warte an deinem Tisch. Die Bestellung wird dir gebracht.',
    ...
    notFoundText: 'Die von dir gesuchte Seite existiert nicht oder wurde verschoben.',
  ...
  en: {
    ...
    resetPasswordSent: 'We sent you an email to reset your password, please follow the instructions.',
    ...
    sendLink: 'Send link',
    agreeToTermsDesc: 'By registering, you agree to our Terms of Service and Privacy Policy.',
    ...
    kitchenSessionsDesc: 'Create a session and open the link on a tablet, accessible to the staff and kitchen if needed. Incoming orders appear there with all details in real time and can be managed.',
    ...
    qrCodeSublineBase: 'Order as usual with our staff or add your desired items to the cart and pay directly via your phone.',
    qrCodeSublineToStay: 'After payment, your order will be brought directly to your table.',
    qrCodeSublineToGo: 'After payment, you will be redirected to a waiting page where you can see whether your order is ready for pickup.',
    qrCodeAdminDescToGo: 'Print out this QR code and place it in a clearly visible spot for your customers. Once the feature is activated, customers can order directly through it.',
    qrCodeAdminDescToStay: 'Enter the desired table number, print out the QR code and place it on the corresponding table. Once the feature is activated, customers can order directly from there.',
    ...
    paymentDisclaimer: 'The technical order and payment processing is handled by zakkig as an intermediary.',
    agreeToTerms: 'I agree to the Terms and Privacy Policy.',
    orderPlaced: 'Order placed!',
    yourOrderNumber: 'Your order number',
    waitAtTable: 'Please wait at your table. Your order will be brought to you.',
...
/**
 * Server-side translation helper (no hooks).
 */
