...
export const PRESET_TEMPLATES: PresetTemplate[] = [
  {
    ...
    descriptionEn:
      "Patty choice, doneness, cheese upgrade, extra toppings & sauce",
    steps: [
      {
        id: generateId(),
        name: "Patty / Fleisch",
    ...
    steps: [
      ...
      },
      {
        ...
        options: [
          {
            id: generateId(),
            name: "Klassisch Italienisch (Dünn)",
            extraPrice: 0,
            available: true,
            sortOrder: 0,
          },
    ...
    steps: [
      {
        ...
        options: [
          ...
          {
            id: generateId(),
            name: "Döner-Teller (mit Pommes/Reis)",
            extraPrice: 350,
            available: true,
            sortOrder: 2,
          },
  ...
  },
  {
    ...
    icon: "☕",
    descriptionDe:
      "Größe, Milchalternative (Hafer, Soja), Sirup-Shots & Extra Espresso",
    ...
    steps: [
      {
        ...
        options: [
          {
            id: generateId(),
            name: "Portion Frische Schlagsahne",
            extraPrice: 100,
            available: true,
            sortOrder: 0,
          },
    ...
    steps: [
      {
        ...
        options: [
          ...
          {
            id: generateId(),
            name: "Umweltfreundlicher Becher",
            extraPrice: 0,
            available: true,
            sortOrder: 1,
          },
