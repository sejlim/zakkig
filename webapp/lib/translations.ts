...
export const translations = {
  de: {
    ...
    bannerRecommended: "1200 × 500 px empfohlen (max. 10 MB)",
    logoRecommended: "Quadratisch empfohlen (max. 10 MB)",
    brandMedia: "Logo & Banner",
    brandMediaDesc: "Gestalte deinen Auftritt auf den Bestellseiten. Klicke auf das Banner oder Logo, um Bilder hochzuladen (max. 10 MB).",
  ...
  en: {
    ...
    bannerRecommended: "1200 × 500 px recommended (max. 10 MB)",
    logoRecommended: "Square recommended (max. 10 MB)",
    brandMedia: "Logo & Banner",
    brandMediaDesc: "Customize your appearance on the ordering pages. Click on the banner or logo to upload images (max. 10 MB).",
