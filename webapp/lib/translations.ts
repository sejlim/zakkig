...
export const translations = {
  de: {
    ...
    autoArchiveNotice:
      "Abgeschlossene Bestellungen werden nach 30 Minuten automatisch ins Archiv verschoben.",
    dineIn: "Vor Ort",
    ...
    tableTooLong: "Die Tischnummer darf maximal 10 Zeichen lang sein.",
    ...
    itemImageRecommended: "800 × 600 px empfohlen",
    ...
    maxFileSize: "JPG, PNG bis 10 MB",
    imageTooLarge: "Das Bild darf maximal 10 MB groß sein.",
    invalidImageFormat: "Nur Bilder im JPG- oder PNG-Format sind erlaubt.",
    ...
    brandMediaDesc: "Gestalte deinen Auftritt auf den Bestellseiten. Klicke auf das Banner oder Logo, um Bilder im Format JPG oder PNG hochzuladen (max. 10 MB).",
  ...
  en: {
    ...
    autoArchiveNotice:
      "Completed orders are automatically moved to the archive after 30 minutes.",
    dineIn: "Dine-in",
    takeaway: "Takeaway",
    table: "Table",
    tableNr: "Table No.",
    ...
    tableTooLong: "The table number must not exceed 10 characters.",
    ...
    itemImageRecommended: "800 × 600 px recommended",
    ...
    maxFileSize: "JPG, PNG up to 10 MB",
    imageTooLarge: "The image must not exceed 10 MB.",
    invalidImageFormat: "Only JPG and PNG images are allowed.",
    ...
    brandMedia: "Logo & Banner",
    brandMediaDesc: "Customize your appearance on the ordering pages. Click on the banner or logo to upload images in JPG or PNG format (max. 10 MB).",
