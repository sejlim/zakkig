...
import { Plus, Trash, CaretUp, CaretDown, DotsSixVertical, PencilSimple, Info, Check } from '@phosphor-icons/react'
  ...
  return (
    <div ref={setNodeRef} style={style} className="bg-transparent flex flex-col border border-primary-foreground/20 rounded-xl overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center justify-between sm:justify-end gap-2.5 shrink-0 w-full sm:w-auto" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="px-3.5 sm:px-4 py-4 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-4 w-full">
            <div className="flex flex-col gap-1.5">
              <label htmlFor={`step-min-${step.id}`} className="text-xs font-medium text-primary-foreground/70 flex items-center gap-1">
                {t('minSelections')}
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor={`step-max-${step.id}`} className="text-xs font-medium text-primary-foreground/70 flex items-center gap-1">
                {t('maxSelections')}
                <TooltipProvider delay={200}>
                  <Tooltip>
                    <TooltipTrigger className="hidden sm:inline-flex items-center">
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor={`step-inc-${step.id}`} className="text-xs font-medium text-primary-foreground/70 flex items-center gap-1">
                {t('includedInPrice')}
                <TooltipProvider delay={200}>
                  <Tooltip>
                    <TooltipTrigger className="hidden sm:inline-flex items-center">
