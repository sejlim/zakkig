...
export default function SignUpPage() {
  ...
  return <SignUpForm state={state} formAction={formAction} isPending={isPending} />
}
...
function SignUpForm({ state, formAction, isPending }: { state: any, formAction: (payload: FormData) => void, isPending: boolean }) {
  const { t, locale } = useTranslation()
